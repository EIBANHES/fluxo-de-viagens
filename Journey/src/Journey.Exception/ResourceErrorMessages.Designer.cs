...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The date of the trip must be than today..
        /// </summary>
        ...
        /// </summary>
        public static string NAME_EMPYT {
            get {
                return ResourceManager.GetString("NAME_EMPYT", resourceCulture);
            }
        }
